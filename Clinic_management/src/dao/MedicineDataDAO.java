...
import repository.MedicineDataRepoMysql;
 ...
 * @author MrLELOI
 */
public class MedicineDataDAO implements IDAO {
    
    private IRepo repo;

    public MedicineDataDAO() {
        this.repo = new MedicineDataRepoMysql();
    }

    public MedicineDataDAO(IRepo _repo) {
        this.repo = _repo;
    }
