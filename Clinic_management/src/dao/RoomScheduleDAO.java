...
import repository.RoomScheduleRepoMysql;
 ...
 * @author MrLELOI
 */
public class RoomScheduleDAO implements IDAO {
    
    private IRepo repo;

    public RoomScheduleDAO() {
        this.repo = new RoomScheduleRepoMysql();
    }

    public RoomScheduleDAO(IRepo _repo) {
        this.repo = _repo;
    }
