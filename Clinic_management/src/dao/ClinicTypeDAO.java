...
import repository.ClinicTypeRepoMysql;
 ...
 * @author MrLELOI
 */
public class ClinicTypeDAO implements IDAO {
    private IRepo repo;

    public ClinicTypeDAO() {
        this.repo = new ClinicTypeRepoMysql();
    }

    public ClinicTypeDAO(IRepo _repo) {
        this.repo = _repo;
    }
