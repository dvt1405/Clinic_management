...
import repository.TestingDataRepoMysql;
 ...
 * @author MrLELOI
 */
public class TestingDataDAO implements IDAO {
    
    private IRepo repo;

    public TestingDataDAO() {
        this.repo = new TestingDataRepoMysql();
    }

    public TestingDataDAO(IRepo _repo) {
        this.repo = _repo;
    }
