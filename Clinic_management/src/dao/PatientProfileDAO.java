...
import repository.PatientProfileRepoMysql;
 ...
 * @author MrLELOI
 */
public class PatientProfileDAO implements IDAO {
    
    private IRepo repo;

    public PatientProfileDAO() {
        this.repo = new PatientProfileRepoMysql();
    }

    public PatientProfileDAO(IRepo _repo) {
        this.repo = _repo;
    }
