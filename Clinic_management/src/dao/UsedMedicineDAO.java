...
import repository.UsedMedicineRepoMysql;
 ...
 * @author MrLELOI
 */
public class UsedMedicineDAO implements IDAO {
    
    private IRepo repo;

    public UsedMedicineDAO() {
        this.repo = new UsedMedicineRepoMysql();
    }

    public UsedMedicineDAO(IRepo _repo) {
        this.repo = _repo;
    }
